                    ...
                    for (; i < psms.Length; i += maxThreadsPerFile)
                    {
                        ...
                        lock (myLocks[i])
                        {
                            if (psms[i] != null)
                            {
                                ...
                                {
                                    if (spectralLibrary.TryGetSpectrum(Peptide.FullSequence, scan.PrecursorCharge, out var librarySpectrum))
                                    {
                                        ...
                                        if (s.CosineSimilarity().HasValue)
                                        {
                                            pwsms.Add((Notch, Peptide));
                                            pwsmSpectralAngles.Add((double)s.CosineSimilarity());
                                        }
                                    }
